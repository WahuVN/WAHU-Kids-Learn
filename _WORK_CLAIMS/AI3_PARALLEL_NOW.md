...
- `468dd55` landed the visual polish; `af48f89` then bound game-art motion to the existing performance policy. Current common-head verification is `dcf844b`.
...
- Verification on `dcf844b`: Child UI **3727 assertions PASS**, Performance **13 assertions PASS**, Motion **25 assertions PASS**, Math persistence **8025 assertions PASS**, `git diff --check` PASS.
