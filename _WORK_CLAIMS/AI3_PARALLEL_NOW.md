...
LAST_VERIFIED_PERSISTENCE=8068_ASSERTIONS_PASS
LATEST_OFFSCREEN_CAPTURE_HEAD=`594f4ba`
...
- `468dd55` landed the visual polish; `af48f89` then bound game-art motion to the existing performance policy. Latest non-release QA verification is `594f4ba`; full release evidence remains `b45dc56`.
...
- Verification on `594f4ba`: Child UI **3743 assertions PASS**, offscreen capture **10 PNG / 3774 assertions PASS**, Performance **13 assertions PASS**, Motion **25 assertions PASS**, Math persistence **8068 assertions PASS**, `git diff --check` PASS.
