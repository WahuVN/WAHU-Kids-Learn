...
- 267/267 distractor có **rationale unique / max repeat 1**, mỗi rationale sai chứa lời giải riêng của chính câu; 3 họ mẫu shallow cũ đã giảm **267 → 0**; riêng **24 distractor thuật ngữ phép tính** hiện có thêm định nghĩa choice-specific bắt buộc (`số hạng/tổng`, `số bị trừ/số trừ/hiệu`, `thừa số/tích`, `số bị chia/số chia/thương`), làm số câu MC/TF dùng chung thân rationale giảm **88 → 80** mà không dùng heuristic suy đoán;
