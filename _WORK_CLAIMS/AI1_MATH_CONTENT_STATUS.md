...
- Math content unittest: **87 / 87 PASS**
...
## First-five polish wave — child-friendly concept language

- Audit lesson instruction found algebraic placeholder notation in two concepts: `n00` for full hundreds and `n - 1 / n + 1` for predecessor/successor.
- Rewritten for Grade-2 readers: full hundreds are explained by **two final digits both being 0**; predecessor/successor by **bớt 1 / thêm 1**.
...
- Full `MathContentDataSmoke`: **87/87 PASS**.
