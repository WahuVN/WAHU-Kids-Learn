...
- 267/267 distractor có **rationale unique / max repeat 1** và **choice-specific diagnosis**; 3 họ mẫu shallow cũ đã giảm **267 → 0**. Các wave structured reasoning bao phủ thuật ngữ phép tính (24), cấu trúc số (24), số tròn trăm/ý nghĩa/chọn phép tính (26), sự kiện (27), đơn vị-thời gian-lịch-đồng hồ-ước lượng (39), đọc số/cân/tiền/pictograph (24), hình học (87), và 4 câu sửa vai trò thành phần phép tính cuối; số câu MC/TF dùng chung thân rationale đã giảm **88 → 0**, mọi structured reason đều được validator tái kiểm từ skill + prompt + choice, không dùng heuristic suy đoán;
