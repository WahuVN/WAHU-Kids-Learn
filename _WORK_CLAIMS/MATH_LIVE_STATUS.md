...
Updated: 2026-09-08
LAST_FULLY_VERIFIED_HEAD=`e3cc0e2`
LATEST_UI_VERIFIED_HEAD=`e3cc0e2`
LATEST_PERSISTENCE_VERIFIED_HEAD=`e3cc0e2`
MATH_3AI_DONE=YES
AI3_LANE_DONE=YES
...
- Release-full artifact hiện tại là `0.1.87-dev` tại clean `e3cc0e2`; full Build-Setup **PASS**, Child UI **3750**, persistence **8145**, production art **74/74 SHA-verified** ở source/app-output/publish/portable-tree/portable-ZIP **và sau Expand-Archive trong Portable E2E**, installer compile và post-installer provenance đều PASS. Offscreen capture riêng vẫn là **10 PNG / 3781** trên `ac77050`.
...
- Latest full release QA on `e3cc0e2`: Child UI **3750 assertions PASS**, persistence **8145 assertions PASS**, build **0 warning / 0 error**, Performance **13**, Motion **25**, full Math content/event/pool **90/90**, production-art packaging **74/74**, extracted Portable E2E asset validation PASS. Offscreen capture remains **10 PNG / 3781 assertions PASS** on `ac77050`.
- `0.1.87-dev`: Build-Setup **PASS** + provenance/content/persistence/production-art/Portable first-class gates + **post-extraction production-art E2E gate** + post-installer provenance, Portable E2E **PASS**, installer compile **PASS**.
- Portable SHA256 `CB3C530D89C9B2B7B47D947453DAFD95E33F5A6C715559CE1EA177B771596C27`; Installer SHA256 `AD0B1F10CD0C115113C9C7F54AAECCBD1BF4A0E26683C7F424279BF0F831568B`; production-art manifest SHA256 `6BD7172D8B7D0239960207B5A43C2CAE466220421F88D6D7C57215005BC1D8A6`.
- `e3cc0e2` hợp nhất Portable/Installer E2E vào shared `Test-ProductionAssetPayload.ps1`, bỏ hard-code 74; release manifest ghi `portable_e2e_production_art_extracted=PASS` và `production_art.portable_extracted_e2e_verified=true`.
...
## Latest fully verified gates — `e3cc0e2 / 0.1.87-dev`
...
- Persistence: Build-Setup `10b/15` build **0 warnings / 0 errors**, **8145 assertions PASS** on `e3cc0e2`.
...
- Build-Setup `0.1.87-dev`: **PASS** cùng sub-gates `0/15`, `6b`, `6c`, `10b`, `13b`, `13c`, `15b`; staged/portable tree+ZIP production-art gates và **post-extraction Portable E2E shared-validator gate** xác nhận **74/74 PNG** theo canonical manifest SHA.
- Portable E2E: **PASS** trong Build-Setup; sau `Expand-Archive` shared validator xác nhận **74/74 + canonical SHA**, bootstrap 2 lần exit 0; learner DB thật trước/sau đều `0C970952435DAC03FE56C8400D003E87C37CED5D91B79C8A7D459A8EC30868C1`.
...
- Artifact `0.1.87-dev`: Portable `CB3C530D89C9B2B7B47D947453DAFD95E33F5A6C715559CE1EA177B771596C27`; Installer `AD0B1F10CD0C115113C9C7F54AAECCBD1BF4A0E26683C7F424279BF0F831568B`; production-art manifest `6BD7172D8B7D0239960207B5A43C2CAE466220421F88D6D7C57215005BC1D8A6`.
...
1. production Authenticode signing — artifact `0.1.87-dev` hiện là unsigned dev build (`signed=false`);
