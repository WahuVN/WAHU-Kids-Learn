    ...
    internal sealed class TypingSpaceKeyboardControl : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (HintVisible)
            {
                ...
                DrawTextWithOwnedFont(g, hint, ChildVisualTheme.Font(9.5f, FontStyle.Bold),
        ...
        private void DrawKey(Graphics g, KeyCell cell)
        {
            ...
            DrawTextWithOwnedFont(g, cell.Key, ChildVisualTheme.Font(11f, FontStyle.Bold), cell.Bounds,
                ChildVisualTheme.Ink, TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter | TextFormatFlags.NoPrefix);
        }

        private static void DrawTextWithOwnedFont(Graphics graphics, string text, Font font, Rectangle bounds, Color color, TextFormatFlags flags)
        {
            using (font)
